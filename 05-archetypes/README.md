...
## Контрольные вопросы
Вопрос :В чём основные отличия REST от выбранного вами типа Web-API WebSockets  
Ответ:  двунаправленный поток данных.  
...
Ответ: WebSockets дают преимущество в случаях, когда требуется: Реальное время (чаты, игры, биржевые котировки).  
Вопрос :Какие ограничения или недостатки имеет выбранный вами архитектурный стиль?  
Ответ: Недостатки WebSockets: Постоянное соединение требует больше ресурсов сервера на поддержание множества соединений.  
Вопрос :Как вы интегрировали новый тип API с уже существующей архитектурой приложения (REST + БД + аутентификация)?  
Ответ:  Для автоматического изменения логов в панели админа.
